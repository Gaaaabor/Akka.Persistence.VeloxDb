...
namespace Akka.Persistence.VeloxDb.Test.Query
{
    ...
    public class VeloxDbCurrentEventsByPersistenceIdSpec : CurrentEventsByPersistenceIdSpec
    {
        public VeloxDbCurrentEventsByPersistenceIdSpec(LocalVeloxDbFixture fixture)
