...
using Akka.Persistence.VeloxDb.Query.Publishers;
using Akka.Streams.Dsl;

namespace Akka.Persistence.VeloxDb.Query
{
    public class VeloxDbReadJournal : IPersistenceIdsQuery,
        ...
        ICurrentEventsByTagQuery
    {
        ...
        public VeloxDbReadJournal(Config config)
        {
        ...
        public const string Identifier = "akka.persistence.query.journal.veloxdb";
